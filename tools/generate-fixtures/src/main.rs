...
/// Run from project root: cargo run --manifest-path tools/generate-fixtures/Cargo.toml
/// Output goes into test-fixtures/ at the project root.
///
        ...
        image::ImageBuffer::from_fn(width, height, |x, y| {
            ...
            if y < (height as f32 * 0.6) as u32 {
                ...
                let noise = ((x as f32 * 0.15).sin() * 18.0
                    + (x as f32 * 0.07 + y as f32 * 0.05).cos() * 12.0)
                    as i32;
                Rgb([
